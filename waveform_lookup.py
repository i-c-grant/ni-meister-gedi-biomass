...
def cli(l1b_path, l2a_path):
    ...
    layers = {
        "Smoothed waveform": {"x": "processed/dp_dz",
                                      "color": "black",
                                      "type": "line"},
        "Estimated ground return": {"x": "processed/ground_return",
                                    "color": "blue",
                                    "type": "line"},
        "Estimated veg. return": {"x": "processed/dp_dz_veg_only",
                                  "color": "red",
                                  "type": "line"},
        "Raw returns": {"x": "processed/wf_raw_scaled",
                        "color": "gray",
                        "type": "scatter"},
    }

    plotter = WaveformPlotter(layer_dict=layers,
                              y_lab="Height (m)",
                              x_lab="Waveform returns")
        ...
        while True:
            ...
            if input.lower() == "quit":
                ...
                try:
                    ...
                    click.echo(f"Invalid shot number: {shot_num}. "
                               f"Please try again.")
